...
Launch it explicitly with `jupyter lab "<COURSE_ROOT>"`. The validation and packaging scripts discover their repository root from their own location and can be invoked from any directory.
